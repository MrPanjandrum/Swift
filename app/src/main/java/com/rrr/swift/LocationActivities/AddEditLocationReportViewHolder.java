...
import com.rrr.swift.ReportActivities.ReportActivity;
import com.squareup.picasso.Picasso;

import java.util.ArrayList;


public class AddEditLocationReportViewHolder extends RecyclerView.ViewHolder
{
    ...
    public AddEditLocationReportViewHolder(final View itemView)
    {
        super(itemView);
